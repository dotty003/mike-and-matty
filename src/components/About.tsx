          ...
          <Reveal delay={0.2}>
             <div className="aspect-[4/5] rounded-[20px] overflow-hidden relative shadow-2xl border border-[#FFD747]/20 group-hover:border-[#FFD747]/50 transition-colors duration-500">
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  <div className="h-1 w-12 bg-[#FFD747] mb-4"></div>
                  <h3 className="text-3xl text-white mb-1 font-serif">{content.founderName}</h3>
                  <p className="text-[#FFD747] font-display uppercase tracking-widest text-xs font-bold">{content.founderSubtitle}</p>
                </div>
             </div>

             <div className="absolute -top-4 -right-4 w-full h-full border border-[#FFD747]/10 rounded-[20px] -z-10 translate-x-4 translate-y-4 transition-transform duration-500 group-hover:translate-x-6 group-hover:translate-y-6"></div>
          </Reveal>
        </div>
        ...
        <div className="w-full md:w-1/2 space-y-8">
          <Reveal>
            <h2 className="text-4xl md:text-6xl leading-tight font-serif text-white">
              {content.title} <span className="text-[#FFD747] italic">{content.titleAccent}</span>
            </h2>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <div className="space-y-6 text-lg text-slate-300 font-light leading-relaxed">
              ...
              <div className="bg-[#111F1B] p-8 rounded-[16px] border border-[#FFD747]/20 mt-6 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-20 h-20 bg-[#FFD747]/10 rounded-full blur-xl"></div>
